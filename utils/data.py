...
def load_COVID_data(prefix='data/preprocessed/COVID_processed'):
    G00 = nx.read_adjlist(prefix + '/0/0-0.adjlist', create_using=nx.MultiDiGraph)
...
#     G21 = nx.read_adjlist(prefix + '/2/2-0-1-0-2.adjlist', create_using=nx.MultiDiGraph)
    ...
    idx00 = np.load(prefix + '/0/0-0_idx.npy')
